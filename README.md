...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-s8sugri.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-s8sugri.containers.anotherwebservice.com/
...
```
git clone git@github.com:810810810/container-s8sugri.git
cd container-s8sugri
```
...
```
docker attach container-s8sugri
```
